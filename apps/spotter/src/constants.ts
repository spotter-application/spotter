...
import { ApplicationsPlugin } from "./plugins/applications/applications.plugin";
import { PluginsManagerPlugin } from "./plugins/plugins.plugin";
...
export const INTERNAL_PLUGINS: {[plugin: string]: typeof SpotterPlugin} = {
  ...
  ['applications-plugin']: ApplicationsPlugin,
