...
export const sortOptions = (
  ...
  return options.sort((a, b) => {
    const aWeight = isPluginOnQueryOption(a) && typeof a.priority !== 'undefined'
      ? a.priority * (-1000000000000)
      : (history[getHistoryPath(b, selectedOption)] ?? 0);

    const bWeight = isPluginOnQueryOption(b) && typeof b.priority !== 'undefined'
      ? b.priority * (-1000000000000)
